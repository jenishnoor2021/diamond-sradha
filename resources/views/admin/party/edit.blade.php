            ...
            <div class="row">
               ...
               <div class="col-3">
                  <div class="form-group">
                     ...
                     <input type="number" name="fancy_7" class="form-control form-control-rounded" id="fancy_7" placeholder="Enter amount" value="{{$party->fancy_7}}">
               ...
               <div class="col-3">
                  <div class="form-group">
                     ...
                     <input type="number" name="fancy_8" class="form-control form-control-rounded" id="fancy_8" placeholder="Enter amount" value="{{$party->fancy_8}}">
